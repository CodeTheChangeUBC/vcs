<?php
 /**
 *
 * @package   VCS Functionality
 * @author    Kevin Hashimoto <dev@kevinhashimoto.com>
 * @license   GPL-2.0+
 * @copyright 2017 Vancouver Cantata Singers
 *
 * @wordpress-plugin
 * Plugin Name: VCS Functionality
