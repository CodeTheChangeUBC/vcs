(function($) {
    ...
    $(window).load(function() {
        $(".concert-post-head img").each(function() {
            var $width = $(this).width(),
                $height = $(this).height(),
                $containerWidth = $(".concert-post-head").width(),
                $containerHeight = $(".concert-post-head").height(),
        ...
        $(".page-timeline .timeline-img-container img").each(function() {
            var $width = $(this).width(),
                $height = $(this).height(),
                $containerWidth = $(
                    ".page-timeline .timeline-img-overlay"
                ).width(),
                $containerHeight = $(
                    ".page-timeline .timeline-img-overlay"
                ).height(),
        ...
        $(".page-conductors .conductor-img-container img").each(function() {
            var $width = $(this).width(),
                $height = $(this).height(),
                $containerWidth = $(
                    ".page-conductors .conductor-img-overlay"
                ).width(),
                $containerHeight = $(
                    ".page-conductors .conductor-img-overlay"
                ).height(),
        ...
        $(
            ".page-history #timeline .timeline-img-container img"
        ).each(function() {
            var $width = $(this).width(),
                $height = $(this).height(),
                $containerWidth = $(
                    ".page-conductors .conductors-img-overlay"
                ).width(),
                $containerHeight = $(
                    ".page-conductors .conductors-img-overlay"
                ).height(),
        ...
        $(
            ".page-history #conductor .conductor-img-container img"
        ).each(function() {
            var $width = $(this).width(),
                $height = $(this).height(),
                $containerWidth = $(
        ...
        $(".page-our-choir .circle-img-container img").each(function() {
            var $width = $(this).width(),
                $height = $(this).height(),
                $containerWidth = $(
                    ".page-our-choire .circle-img-container"
                ).width(),
                $containerHeight = $(
                    ".page-our-choire .circle-img-container"
                ).height(),
        ...
        $(".post-type-archive-concerts .concert-img img").each(function() {
            var $width = $(this).width(),
                $height = $(this).height(),
                $containerWidth = $(
                    ".post-type-archive-concerts .concert-img"
                ).width(),
                $containerHeight = $(
                    ".post-type-archive-concerts .concert-img"
                ).height(),
